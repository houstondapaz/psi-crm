export const messagesPtBr = {
  ...
  labelColors: {
    mintPastel: "Verde menta claro",
    yellowPastel: "Amarelo claro",
    orangePastel: "Laranja claro",
    pinkPastel: "Rosa claro",
    lavenderPastel: "Lavanda",
    green: "Verde",
    yellow: "Amarelo",
    orange: "Laranja",
    red: "Vermelho",
    ...
    orangeDark: "Laranja escuro",
    redDark: "Vermelho escuro",
    purpleDark: "Roxo escuro",
    bluePastel: "Azul claro",
    skyPastel: "Céu claro",
    limePastel: "Lima claro",
    pinkLight: "Rosa suave",
    grayLight: "Cinza claro",
    blue: "Azul",
    sky: "Ciano",
    lime: "Lima",
    pink: "Rosa",
    ...
    tealDark: "Verde-azulado escuro",
    greenOlive: "Verde oliva",
    magenta: "Magenta",
    grayDark: "Cinza escuro",
  },
  toast: {
    dismiss: "Fechar",
  ...
  labels: {
    ...
    showMore: "Mostrar mais etiquetas",
    createNew: "Criar uma nova etiqueta",
    editLabel: "Editar etiqueta {name}",
